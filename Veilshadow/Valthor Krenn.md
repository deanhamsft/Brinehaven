...
- Skills: Arcana +9, History +9 (Sage), Investigation +9 (Wizard), Perception +5 (Drow)
...
- Drow Magic (Charisma): Dancing Lights (cantrip); Faerie Fire (1/day); Darkness (1/day).

Wizard Features

- Spellcasting (Intelligence-based ritual casting).
- Arcane Recovery: Recover up to 4 levels of spell slots (1/short or long rest).
- Necromancy Savant (lvl 2): Copy necromancy spells into spellbook at half cost/time.
- Grim Harvest (lvl 2): Kill a creature with a 1st+ level spell slot? Regain HP equal to 2× spell level (3× on crit). Humanoids/necro spells only.
- Undead Thralls (lvl 6):
    - Animate Dead (3rd-level slot) creates one extra zombie/skeleton.
    - Once per dawn: Cast Animate Dead (one creature) without a slot.

Spellcasting

Spell Slots: 4 (1st) / 3 (2nd) / 3 (3rd) / 3 (4th) / 2 (5th)  
Cantrips Known (5): Chill Touch, Mage Hand, Minor Illusion, Prestidigitation, Toll the Dead  
Spells Prepared (14 total, chosen daily from spellbook): Focus on shadows, control, and undead.

|Level|Prepared Spells (Thematic Selection)|
|---|---|
|1st|Mage Armor, Magic Missile, Shield, Find Familiar (shadow mastiff reskin), False Life|
|2nd|Misty Step, Mirror Image, Invisibility, Hold Person|
|3rd|Animate Dead, Counterspell, Vampiric Touch, Dispel Magic|
|4th|Blight, Dimension Door, Evard's Black Tentacles|
|5th|Cloudkill, Shadow of Moil (Xanathar's)|

Full Spellbook (50+ spells; highlights): All wizard list up to 5th + necromancy staples (Animate Dead, Blight, Vampiric Touch, False Life). Shadow-flavored: Darkness, Shadow Blade (if Xanathar's), Enervation (if allowed).Tactics: Opens with Darkness (racial, no concentration) + Animate Dead swarms (6+ skeletons/zombies w/ Thralls). Shadow of Moil blinds attackers. Counterspell locks casters. Flees via Misty Step/teleport.

Equipment & Magic Items

- Worn: Black silk robes (absorb light; flavor), silver skull mask.
- Weapons: Dagger (+1 magic, deals necrotic dmg on crit).
- Adventuring Gear: Spellbook (bound in shadow dragon hide), arcane focus (obsidian orb), component pouch, scholar's pack, 200 gp (shadow essence vials).
- Magic Items (CR-appropriate):
    
    |Item|Effect|
    |---|---|
    |Bag of Holding|Portal to shadow pocket.|
    |Wand of Magic Detection (7 charges)|Detects life/magic in shadows.|
    |Ring of Mind Shielding|Immune to mind reading; hides alignment.|
    |Scrolls|Teleport (emergency), Animate Dead (x2).|
    

Lair Actions (if boss fight in sanctum): Shadows animate (DC 17 Dex save or restrained), necrotic fog (DC 17 Con or 4d6 poison).
