Location: 30 miles northwest of Brinehaven, nestled in the forested foothills of the Ironspike Mountains. The journey takes 2 days on horseback (via Woodcock Stables, 40 gp rental per horse) or 4-5 days on foot, through dense pines and rocky passes (DC 13 Wisdom (Survival) or get lost, adding 1 day). The mine entrance is a weathered stone archway half-buried in vines, engraved with faded dwarven runes reading "Khazad-Durak" (Dwarven for "Stone Delve"). Smoke from geothermal vents hints at dangers below.
...
- Tactics: Duergar Enlarge (grow to Large); spiders web from ceilings.
![[Duergar.png]]
![[Giant Spider.png]]
...
- From Brinehaven: Lirien or Cavlin Stonehowl mentions a lost dwarven map leading to "mithril riches" (quest for relic to aid ward).
- Tie-Ins: Relic strengthens hearthstone against Retch's reagent.
- Travel: 2 days NW; random: wolves, bandits.

> [!NOTE]
> DM Notes
> 
> - XP Total: ~5,400 (hard for 5 L4; short rests between levels).
> - Scaling: L3: Remove 1 duergar/spider/zombie. L5: Add gricks.
> - Hazards: Darkness (DC 15 Perception disadvantaged), poison gas.
> - Treasure: ~500 gp + magic items.
> - Map Sketch (5 ft squares):
