...
- Personality:
    ...
    - Bond: A locket from his elven mother, a reminder of his heritage and the ward’s importance.
    - Flaw: Indecisiveness—his doubts slow his actions unless pushed.
- Abilities (Level 2 Rogue):
    - Stats: AC 14 (leather), HP 14 (2d8+2), Speed 30 ft. Str 10, Dex 15, Con 12, Int 11, Wis 13, Cha 10.
...
4. Dwalin "Saltbeard" Kray

- Race: Half-Elf
- Age: 25
- Gender: Male
- Occupation: Deputy Sheriff
- Appearance: A wiry half-elf with salt-crusted beard braids, tanned skin, and piercing blue eyes. His cloak is patched from dockside scuffles, and he smells faintly of brine.
- Personality:
    - Traits: Sly and opportunistic, Dwalin is charming but self-serving.
    - Ideal: Coin flows to the clever—He justifies corruption as "survival in a hard village."
    - Bond: A silver compass from his elven father, used to navigate smuggling routes.
    - Flaw: Greedy—he haggles over bribes and might betray Drenvar for a better offer.
- Abilities (Level 2 Rogue):
    - Stats: AC 14 (leather), HP 15 (2d8+2), Speed 30 ft. Str 10, Dex 16, Con 12, Int 12, Wis 11, Cha 13.
    - Saving Throws: Dex +5, Int +3
    - Skills: Stealth +5, Deception +4, Perception +2
    - Features: Sneak Attack (1d6), Cunning Action
    - Equipment: Rapier (1d8+3 piercing), dagger, leather armor, sheriff’s badge, silver compass.
- Role in Brinehaven: Dwalin scouts smuggling drops and interrogates suspects, skimming 5 gp per load for Retch. Less loyal than Gavric, he's open to flipping. 
- Campaign Tie-In: Dwalin's compass points to Retch's shack (DC 14 Intelligence (Investigation)). He knows the reagent's purpose (ward disruption) and could defect with proof of Drenvar's double-dealing.
- Interaction:
    - Line: “Easy now, friends. Sheriff’s got rules, but I’m flexible. Coin talks—what’s your angle?”
    - Quest Offer: "Escort a 'merchant'" (25 gp, ambushes sahuagin en route to sea hag lair).

Campaign Integration

- Smuggling Ring: Garrick provides muscle for shipments; Dwalin scouts routes. Both know Jorin's role but fear Retch.
- The Auror’s Bounty: They’ve heard Retch boast of the wreck, offering leads if turned.
- Rune Connection/Hearthstone’s Secret: Dwalin's elven blood senses ward strain, hinting at reagent effects.
- Full Deputy Roster: With Gavric (loyal brute), Tyrus (doubter), Garrick (enforcer), and Dwalin (opportunist), the sheriff's force is balanced for intrigue.

Interaction with the Party

- Encounter:  Garrick arm-wrestles near the Hearth; Dwalin haggles at the docks. They patrol together at night.
- Dialogue Exchange:  
    Garrick: “Oi! You again? Back off or I’ll crack skulls!”  
    Dwalin: (smirking) “Now, Ironfist, let’s hear ‘em out. Might be worth a cut…”
- Options:
    - Persuasion (DC 14): Bribe/flip Dwalin (50 gp). Success reveals shack; failure alerts Drenvar.
    - Intimidation (DC 15): Bully Garrick. Success forces quest; failure fight.

Combined Quest: Smuggler Escort

- Objective: "Guard a wagon" north (25 gp each, 50 total).
- Challenge: Ambush by 2 sahuagin (200 XP), DC 14 Wisdom (Perception) for clues.
- Reward: 50 gp, reagent vial sample, 250 XP.

DM Notes

- Level Range: Deputies (CR 1/2 each) suit Level 2-4. Scale fights with 1 Thug.
- Pacing: Encounters fit afternoons; quests evening.
- Corruption: Dwalin flips easiest (DC 13); Garrick requires evidence.
- Rewards: 50 gp + intel for Level 3 progression.

Campaign Integration

- The Auror’s Bounty: Both deputies can be leveraged to uncover Retch’s plans, especially if the party reveals the reagent’s role in the wreck.
- Rune Connection: Tyrus’s elven heritage makes him sensitive to the markers, offering insight (DC 15 Intelligence (Arcana)) if trusted.
- Hearthstone’s Secret: Gavric guards the Hearth during rituals, while Tyrus notes its dimming, hinting at the ward’s strain.
- Carival and Smugglers: Gavric’s loyalty shields Drenvar’s ring, while Tyrus’s doubts could expose it, clashing with Kael’s crew.
- Sahuagin Threat: Both have fought sahuagin, making them potential allies against the priestess.
...
- Options:
    ...
    - Insight (DC 14): Gauge their stances. Success notes Tyrus’s doubt; failure needs evidence.

Quest: Combined Patrol

- Objective: Patrol the south coast and forest cave outskirts, reporting back.
- Challenge: DC 13 Wisdom (Perception) for Gavric’s coast (1 bandit), DC 14 for Tyrus’s cave (1 stirge). Success reveals smuggling hints; failure alerts Drenvar.
- Reward: 35 gp (15 + 20), Tyrus’s trust if evidence is shared, 200 XP.

DM Notes

- Level Range: Deputies (CR 1/2 each) and quests suit Level 2-3 (200-300 XP). Scale with 1 Thug (CR 1/2) for Level 4.
