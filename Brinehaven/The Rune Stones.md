...
> [!warning]
> Each marker requires the party to have both the Dwarven belt and the Elven dagger, a member must pass a DC 14 performance check while playing Ysmeine’s flute to activate the marker.
...
3. Stormwatch Point Marker
	...
	- Description: **Atop a promontory overlooking the sea, near the ruins of an old logging, man camp, two 10 foot tall Elven statues, their heads bowed appearing to weep, stand on either side of an 8-foot-tall marker, its runes glowing faintly under the midday sun. The site is windswept, with a crumbling stone platform and a view of the horizon where storms brew.
	- Activation: The performance check reveals: ==“The third key unlocks the path to the last.”== Success projects a holographic image of the hearth at The Brinehaven Hearth.
...
Trigger: Activating all three markers successfully triggers an encounter. A shimmering portal opens above the Stormwatch Point marker, and a sea spirit (use Water Elemental stats, CR 5, with neutral alignment) emerges, its form a swirling mass of water and mist with glowing eyes.
