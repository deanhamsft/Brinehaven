...
- Traits: Stern and calculating, Drenvar masks his corruption with a gruff, honorable facade. His dry humor hides a growing paranoia about exposure.
- Ideal: Power through control—Drenvar justifies his corruption as protecting Brinehaven’s stability.
- Bond: His father’s leather journal, now a ledger for smuggling profits, which he hides in his office.
- Flaw: Greed and overconfidence—he underestimates the party’s ability to uncover his scheme.

Abilities (Level 3 Fighter)

- Stats: AC 16 (chain shirt), HP 24 (3d10+3), Speed 30 ft. Str 14, Dex 12, Con 13, Int 11, Wis 12, Cha 13.
- Saving Throws: Str +4, Con +3
- Skills: Intimidation +3, Perception +3, Deception +3
- Features: Fighting Style (Defense), Second Wind, Action Surge (1/short rest)
- Equipment:
    - Trident (1d6+2 piercing, thrown 20/60 ft)
    - Chain shirt
    - Sheriff’s badge (iron, nonmagical)
    - Signal whistle (alerts 1d4 guards, CR 1/8, in 1d4 rounds)
    - Hidden ledger (DC 15 Intelligence (Investigation) to find in office)
...
- Operation: Drenvar uses his position to overlook smuggler activity, while Jorin sources reagents (e.g., moonkelp, ironwort) from local herbalists like Mara Greenleaf (unwittingly) and coordinates with Kael Draven’s crew. The shadowy customer pays 100 gp per shipment, delivered via Blackreef Cove.
- Reagents: Used for potions or rituals, possibly linked to the pearl’s curse or Carival’s sorcery. A failed DC 15 Intelligence (Nature) check by the party might misidentify them as mundane herbs.
- Customer: Implied as Carival (or Valthor’s proxy), seeking reagents for the kraken ritual. Drenvar doesn’t know the full plan but suspects power beyond coin.
